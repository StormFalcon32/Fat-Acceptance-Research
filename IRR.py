...
benlabels = []
orig = []
with open(r'D:\Python\FatAcceptance\Training\1000Selected0.csv', encoding='utf-8') as f:
    reader = csv.reader(f)
    line = 0
    for row in reader:
        if line == 0:
        ...
        orig.append(row[:-1])
sadielabels = []
with open(r'D:\Python\FatAcceptance\Training\1000Selected0Sadie.csv', encoding='utf-8') as f:
    reader = csv.reader(f)
    line = 0
    for row in reader:
        if line == 0:
